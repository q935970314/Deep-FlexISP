...
import torch
from mwisp_arch import MWRCAN as NET
import math
import glob
...
def get_net(NET, checkpoint_path, device):
    ...
    try:
        ...
        load_net = load_net['state_dict_cnn_denoiser']
...
checkpoint_path = "../stage3/checkpoints/net_g_20000.pth"
model = get_net(NET, checkpoint_path, device)

data_root = "../stage2_output"
...
for inp in tqdm(input_list):
    ...
    img = np.pad(img, ((0, 12), (0, 8), (0, 0)), 'reflect')
